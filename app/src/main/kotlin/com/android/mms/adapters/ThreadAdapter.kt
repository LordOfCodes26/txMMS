        ...
        messageBinding.apply {
            ...
            threadMessageBodyWrapper.apply {
                ...
                if (selectedBubbleOption == null) {
                    ...
                    applyCustomBubbleBackground(activity, bubbleDrawable, bubbleStyle, isReceived = true)
                }
        ...
        messageBinding.apply {
            ...
            threadMessageBodyWrapper.apply {
                ...
                if (selectedBubbleOption == null) {
                    ...
                    applyCustomBubbleBackground(activity, bubbleDrawable, bubbleStyle, isReceived = false)
                }
            }
            setupMessageTimeSim(messageBinding, message, contrastColorReceived)
