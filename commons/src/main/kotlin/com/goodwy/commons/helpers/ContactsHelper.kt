...
class ContactsHelper(val context: Context) {
    ...
    fun mapRelationEditTypeToProviderTypeLabel(type: Int, label: String): Pair<Int, String> =
        getRelationAndroidTypeLabelFromEditTypeLabel(type, label)
